module ParamsHelper
  ...
  def invalid_params
    {
      Excavator: { CompanyName: nil, Address: nil, City: nil, State: nil, Zip: nil },
      DateTimes: { ResponseDueDateTime: nil },
      ServiceArea: {
        PrimaryServiceAreaCode: { SACode: nil },
        AdditionalServiceAreaCodes: { SACode: ['1', '2'] }
      },
      ExcavationInfo: {
        DigsiteInfo: { WellKnownText: nil }
      }
    }
  end
end